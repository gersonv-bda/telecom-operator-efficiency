...
\* \*\*`notebooks/`:\*\* EDA, ingeniería de variables y validación de hipótesis\[cite: 1].
...
El proyecto incluye pruebas de normalidad y varianza (\*\*Levene \& t-test\*\*) para asegurar que las etiquetas de "ineficacia" correspondan a patrones de comportamiento técnico y no a fluctuaciones aleatorias del volumen de llamadas\[cite: 1].
